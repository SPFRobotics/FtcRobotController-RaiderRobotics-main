package org.firstinspires.ftc.teamcode.OpModes.Outdated.Others;
...
@Autonomous
@Disabled
public class AutoTestAJLZARSF extends LinearOpMode {
...
//        BACK_RIGHT
    ...
    public void driveEncoder(Direction direction, double distance, double power) {
        ...
        switch (direction){
            case FORWARD:
                ...
                //TODO: determine new
                //
                // target position for each wheel
                break;
            case BACKWARD:
                newleftFrontTarget = leftFrontWheel.getCurrentPosition()- (int) distanceCm;
                newrightFrontTarget = rightFrontWheel.getCurrentPosition()- (int)distanceCm;
    ...
    public void runOpMode(){
        ...
        if (opModeIsActive()) {
            ...
            sleep(1000);
            while (opModeIsActive() && isBusy()){/*Wait until all motors reach their destination*/}
