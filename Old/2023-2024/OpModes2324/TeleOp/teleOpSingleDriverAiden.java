package org.firstinspires.ftc.teamcode.OpModes2324.TeleOp;
...
public class teleOpSingleDriverAiden extends LinearOpMode {
    ...
    private static final double launchAngle = 0.184;
    ...
    private void Drone() {
        if (endGameTimer.seconds() >= 0) {
            if (gamepad1.left_bumper && gamepad1.right_bumper) {
                if (previousGamepad1.touchpad_finger_1 && !currentGamepad1.touchpad_finger_1) {
                    fingerTouching = false;
                }
                if (!previousGamepad1.touchpad_finger_1 && currentGamepad1.touchpad_finger_1) {
                    fingerStartY = currentGamepad1.touchpad_finger_1_y;
                    fingerTouching = true;
                }
                if (fingerTouching) {
                    if (currentGamepad1.touchpad_finger_1_y > (fingerStartY + changeInY)) {
